...
enum WhisperModelOption: String, Codable, CaseIterable, Identifiable, Sendable {
  case largeV3TurboQ5Zero = "large-v3-turbo-q5_0"
  case largeV3TurboQ8Zero = "large-v3-turbo-q8_0"
  case largeV3Turbo = "large-v3-turbo"
  case base = "base"

  nonisolated static let `default` = largeV3TurboQ5Zero

  nonisolated var id: String { rawValue }

  nonisolated var menuLabel: String {
    switch self {
    case .largeV3TurboQ5Zero:
      "Large v3 Turbo Q5_0 (~500 MB)"
    case .largeV3TurboQ8Zero:
  ...
  nonisolated var downloadURL: URL {
    URL(
      string: "https://huggingface.co/\(sourceRepository)/resolve/main/\(filename)?download=true")!
  }
